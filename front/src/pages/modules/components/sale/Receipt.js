...
const Receipt = ({ order, setOrder }) => {
  ...
  const computeTotal = () => computeSubtotal() + computeDiscount() + computeTax();
  ...
  const handleAddDiscount = (_discount) => {
    ...
    <>
      <div className="container">
                ...
                <div className={classNames(['discount', discount && discount.value > 0 ? '' : 'hidden'])}>
                  <div className="label">
                    <Typography variant="body1">
                      Discount
                      {' '}
                      { discount && discount.method === 'Percent' ? `${discount.value * 100}%` : '' }
                    </Typography>
                  </div>
                  <div className="amount">
        ...
        <div className="controller">
          ...
          <Button
            variant="contained"
            onClick={() => setDiscountOpen(!!order.length)}
          >
            Discount
          </Button>
          <Button
